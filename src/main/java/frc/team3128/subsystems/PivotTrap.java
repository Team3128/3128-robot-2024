...
public class PivotTrap extends NAR_PIDSubsystem{
    
    private static PivotTrap instance;
    private NAR_CANSparkMax m_pivotMotor;
    public double offset;
    public SetpointTest setpointtest = new SetpointTest("Pivot Trap", 0.5, 2000.0);
    ...
    public static synchronized PivotTrap getInstance(){
        if(instance == null){
            instance = new PivotTrap();
        }
        return instance;
    }
