...
public class WristTrap extends NAR_PIDSubsystem{
    
    private static WristTrap instance;
    private NAR_CANSparkMax m_pivotMotor;
    public double offset;
    public SetpointTest setpointtest = new SetpointTest("Wrist Trap", 0.5, 2000.0);
    ...
    public static synchronized WristTrap getInstance(){
        if(instance == null){
            instance = new WristTrap();
        }
        return instance;
    }
