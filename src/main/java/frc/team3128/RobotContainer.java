...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        // TODO: UNCOMMENT
        //mid feed
        controller.getButton(XboxButton.kStart).onTrue(rampUp(()-> 13, MIDDLE_FEED_RPM)).onFalse(feed(MIDDLE_FEED_RPM, 13, MIDDLE_FEED_ANGLE));
        ...
        //edge feed
        controller.getButton(XboxButton.kB).onTrue(rampUp(()->13, EDGE_FEED_RPM)).onFalse(feed(EDGE_FEED_RPM, 13, EDGE_FEED_ANGLE));   //Feed Shot
        ...
        //amp
        controller.getButton(XboxButton.kY).onTrue(rampUp(()->Climber.Setpoint.AMP.setpoint, AMP_RPM).andThen(ampMechanism.extend())).onFalse(ampShoot()); //Amp Shot
        ...
        //outtake
        controller.getButton(XboxButton.kLeftStick).onTrue(intake.outtake()); //Amp LED
        //rezero
        controller.getButton(XboxButton.kX).onTrue(runOnce(()-> swerve.zeroGyro(0)));
